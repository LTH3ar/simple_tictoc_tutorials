//
// Generated file, do not edit! Created by opp_msgtool 6.0 from tictoc17.msg.
//
...
class TicTocMsg17;
/**
 * Class generated from <tt>tictoc17.msg:2</tt> by opp_msgtool.
 * <pre>
 * message TicTocMsg17
 * {
 *     int source;
...
class TicTocMsg17 : public ::omnetpp::cMessage
{
  ...
  protected:
    bool operator==(const TicTocMsg17&) = delete;
...
template<> inline TicTocMsg17 *fromAnyPtr(any_ptr ptr) { return check_and_cast<TicTocMsg17*>(ptr.get<cObject>()); }
